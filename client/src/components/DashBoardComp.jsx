...
export default function DashboardComp() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch('/api/user/routes/getusers?limit=5');
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch('/api/post/routes/getposts?limit=5');
        const data = await res.json();
        if (res.ok) {
          setPosts(data.posts);
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch('/api/comment/routes/getcomments?limit=5');
        const data = await res.json();
        if (res.ok) {
